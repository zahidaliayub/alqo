...
In order to support loading of multiple wallets in alqo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is alqo.cpp.
...
Changes to alqo.cpp
----------------------
alqo.cpp is the entry point into alqo-qt, and as such, will require some minor modifications to provide hooks for
