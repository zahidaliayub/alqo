...
This means one can have an always-on alqod instance running, and another local alqod/alqo-qt instance which connects to this node and receives blocks from it.
