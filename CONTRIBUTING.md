Contributing to ALQO Core
============================

The ALQO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ALQO Core project, and is not to be
confused with overall ALQO Network Protocol consensus changes.

Whether a pull request is merged into ALQO Core rests with the project merge
...
Patches that change ALQO consensus rules are considerably more involved than
...
Where a patch set proposes to change the ALQO consensus, it must have been
...
The project leader is the release manager for each ALQO Core release.
